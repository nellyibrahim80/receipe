...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    Provider.of<AdvProvider>(context,listen: false,).advFromJson();
            ...
            children: [
              ...
              SizedBox(
                ...
                child: Consumer<AdvProvider>(
                  builder: (BuildContext context, value, Widget? child) { return Stack(children: [
                    Column(
                      children: [
                        CarouselSlider(
              ...
              Consumer<AdvProvider>(builder: (cntxt, Rvalue, child) {
