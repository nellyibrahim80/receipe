...
class _FilterPageState extends State<FilterPage> {
  ...
  void initState() {
    ...
    var targetRecipe =
        Provider.of<RecipeFireProvider>(context, listen: false).mealtypeList;
  ...
  Widget customedSlider(
    ...
    int divisions,
    var varName,
    Function(double) onChangedCallback,
  ) {
    return Column(
      children: [
        Padding(
  ...
  Widget build(BuildContext context) {
    ...
    var mealtypeTitles =
        Provider.of<RecipeFireProvider>(context, listen: true).mealtypeList.map((e) => e.MealType).toSet().toList();
              ...
              children: [
                Row(
                  children: mealtypeTitles.map((mealTypeTitle) {
                    ...
                    return Row(
                      children: [
                        ChipSlide(mealTypeTitle as String),
                      ],
                    );
                  }).toList(),
                )
              ...
              Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) => ListRecipesTemplete(
                            listRecipesWidget: RecipeFromQuery(
                              Targetrecipe: targetRecipe,
                              whereCriteria: "search",
                              condition: selectedUserValue,
                            ),
                            pageTitle: "Filter",
                          )));
            },
